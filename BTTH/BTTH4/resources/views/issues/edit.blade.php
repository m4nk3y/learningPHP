...
<body>
    ...
    <h1 style="margin: 50px 50px">Cập nhật thông tin lỗi</h1>
    ...
    <form action="{{ route('issues.update', $issue->id) }}" method="POST" style="margin: 50px 50px">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description" rows="3" value="" required>{{ $issue->description }}</textarea>
        </div>
        ...
        <a href="{{ route('issues.index') }}" class="btn btn-submit">Hủy</a>
    </form>
